...
# --- LÓGICA DE CONFIGURACIÓN HÍBRIDA ---
try:
    import config
...
# --- FUNCIONES EXTRA (SUMA DE SENTIMIENTO) ---
def get_fear_greed():
    try:
...
# --- MOTOR DE DATOS (KUCOIN - ANTI BLOQUEO) ---
@st.cache_data(ttl=40)
def get_market_data():
    # Cambiado a KuCoin para evitar el error 451 de Binance en la nube
    exchange = ccxt.kucoin({'enableRateLimit': True})
    try:
        markets = exchange.load_markets()
        # Filtramos monedas activas con par USDT
...
# SUMA: Indicador de Miedo y Codicia
...
if df is not None:
    ...
    with tab_risk:
        ...
        if os.path.exists(PORTFOLIO_FILE):
            ...
            else: st.info("El portfolio está vacío.")
